...
class notificationVC: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if typeArray[indexPath.row] == "peeps" {
            cell.infoLbl.text = "now peeping you."
        }
    ...
    @IBAction func usernameBtnClick(sender: AnyObject) {
        ...
        let cell = tableView.cellForRowAtIndexPath(i) as! notificationCell
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if cell.infoLbl.text == "has mentioned you." {
            ...
            // send related data to global varible
        ...
        if cell.infoLbl.text == "has commented your post." {
            ...
            // send related date to global varible
            commentuuid.append(uuidArray[indexPath.row])
            commentowner.append(ownerArray[indexPath.row])
        ...
        // going to user peeped current user
        if cell.infoLbl.text == "now peeping you." {
